---
description: "Pull the REAL artifact (prod output, live API spec, captured wire body, live query) and diff the code's output field-by-field; never fabricate a sample"
agent: "agent"
