---
description: "Triage PR review comments — list unresolved Copilot/human review threads, address them, and resolve via GraphQL"
agent: "agent"
tools: ["execute/runInTerminal", "search/codebase", "search", "edit/editFiles"]
---

# PR review triage — PR #${input:pr:PR number}
