...
description: 'Read-only adversarial code reviewer — tries to BREAK the code (edge cases, races, failure branches, contract drift, security), not validate it. Use as a subagent in the pre-ship gate.'
