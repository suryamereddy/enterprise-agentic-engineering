...
description: Validate every Mermaid diagram in repo Markdown locally with the real parser (mermaid@11 + jsdom, no Chromium) before pushing. Catches the GitHub render parse errors that the in-editor preview misses.
user-invocable: true
argument-hint: "[path glob, default docs/**/*.md]"
allowed-tools: Bash, Read, Grep, Glob
---

# Validate Mermaid diagrams locally — $ARGUMENTS
